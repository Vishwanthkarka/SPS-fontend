        ...
        <div className="flex flex-wrap md:flex-row justify-center md:justify-between text-[#000000] text-center  md:px-[5rem] py-3 pb-[30px]">
          {props.isAdmin ? (
            <div className="flex gap-5">
              {" "}
              <img
                src={(Userinf.userinfo !== undefined )?(Userinf.userinfo.photo.secure_url):"https://visualpharm.com/assets/387/Person-595b40b75ba036ed117da139.svg"}
                alt=""
                width="60px"
                height="65px"
              ...
              <div className="flex flex-col">
                {" "}
                <h3>{(Userinf.userinfo !== undefined )?(Userinf.userinfo.name):"....."}</h3>{" "}
                <p className="text-[#606F7B] font-[Avenirregular] "> {(Userinf.userinfo !== undefined )?(Userinf.userinfo.section):"....."}</p>{" "}
              </div>{" "}
            </div>
          ) : (
            " "
